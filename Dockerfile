...
# Aufruf:   docker build --tag juergenzimmermann/cafe:2026.4.1-hardened .
#               ggf. --no-cache
#
...
#
#           docker debug juergenzimmermann/cafe:2026.4.1-hardened
#           docker scout sbom juergenzimmermann/cafe:2026.4.1-hardened
#           docker scout cves juergenzimmermann/cafe:2026.4.1-hardened
#           docker save juergenzimmermann/cafe:2026.4.1-hardened > cafe.tar
...
LABEL org.opencontainers.image.title="cafe" \
    org.opencontainers.image.description="Appserver cafe mit Basis-Image Trixie hardened" \
