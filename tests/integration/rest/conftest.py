...
"""Fixture für pytest: Neuladen der Datenbank für das Cafe-Projekt."""
...
def check_readiness_per_session() -> None:
    """Stellt sicher, dass der Appserver bereit ist."""
    check_readiness()
...
def populate_per_session() -> None:
    """Fixture, um die DB und Keycloak für das Cafe-Projekt neu zu laden."""
    db_populate()
