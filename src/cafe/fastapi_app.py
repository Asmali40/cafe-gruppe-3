...
from cafe.banner import banner
from cafe.config import (
    dev_db_populate,
    dev_keycloak_populate,
)
from cafe.config.dev.db_populate import db_populate
from cafe.config.dev.db_populate_router import router as db_populate_router
from cafe.config.dev.keycloak_populate import keycloak_populate
from cafe.config.dev.keycloak_populate_router import (
    router as keycloak_populate_router,
)
from cafe.graphql_api import graphql_router
...
from cafe.security import router as auth_router
...
# R E S T
# --------------------------------------------------------------------------------------
app.include_router(cafe_router, prefix="/rest")
app.include_router(cafe_write_router, prefix="/rest")
...
def favicon() -> FileResponse:
    ...
    favicon_path: Final = Path("cafe") / "static" / file_name
